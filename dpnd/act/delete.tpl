...
<center>
    <form id="window" method="post">
        ...
        <input id="hover" type="submit" value="No" name="confirm"/>
</center>
</form>
</center>
';
...
elseif(myfile($_GET['delete']) ==  true and isloggedin() == true and $_POST['confirm'] == 'No')
{
echo '
<br>
<link rel="stylesheet" type="text/css" href="dpnd/css/login.css">
<center>
    <h1>Reversing the changes</h1>
    <img src="dpnd/images/load.gif"/>
</center>
<script type="text/javascript">
    setTimeout(function () {
        window.parent.window.location.href = \'./?active=tab-2\';
    }, 0);
</script>
';
}
