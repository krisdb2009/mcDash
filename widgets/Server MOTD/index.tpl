<h1 STYLE="font-size:25px;line-height:25px;text-shadow:1px 1px 0px black">
<?php
$onl = sendjson('server.settings.motd','""');
$onl = json_decode($onl);
$int = 0;
if(isset($onl[0]->success) and !empty($onl[0]->success))
{
    echo MinecraftColors::convertToHTML($onl[0]->success, true);
}
else
{
